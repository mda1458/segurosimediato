  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Os Seguros de Auto da Imediato têm coberturas completas para seu carro a partir de R$ 79,99 por mës. Perda e roubo 100% da tabela FIPE. Colisão. Perda Total. Assistencia 24 Hs. Cotação em 16 Seguradoras. Especialistas em Auto. Calcule Online Já. Roubo, Furto, Colisão, Incêndio, Ass24hs, RCF, Vidros, mais Cobertura Imediata. Cote agora sem compromisso, tenha o menor valor com as melhores coberturas do mercado."
        />
        <meta property="og:title" content="Cotação Seguro Auto - Cotação Grátis e Completa Sem Compromisso" />
        <meta
          property="og:description"
          content="Os Seguros de Auto da Imediato têm coberturas completas para seu carro a partir de R$ 79,99 por mës. Perda e roubo 100% da tabela FIPE. Colisão. Perda Total. Assistencia 24 Hs. Cotação em 16 Seguradoras. Especialistas em Auto. Calcule Online Já. Roubo, Furto, Colisão, Incêndio, Ass24hs, RCF, Vidros, mais Cobertura Imediata. Cote agora sem compromisso, tenha o menor valor com as melhores coberturas do mercado."
        />
        <meta name="twitter:title" content="Cotação Seguro Auto - Cotação Grátis e Completa Sem Compromisso" />
        <meta
        ...
        <meta name="google-site-verification" content="gvuNZwT0SmBGuxpf0OGB_yZQZ3WWAMEnNfPxJtXk11Y" />
      ...
      />
      <Script src="https://www.googletagmanager.com/gtag/js?id=UA-123256811-1" strategy="afterInteractive" />
      ...
      <Script src="https://www.googletagmanager.com/gtag/js?id=AW-815139667" strategy="afterInteractive" />
      ...
      <body page="home" className="body">
            ...
            <div className="dvblksess2-2">
              <div className="div-block-38">
                <a href="/" id="link-home" aria-current="page" className="link-image-header-2 w-inline-block w--current">
                  <img src="/images/logotipo-imediato-seguros.svg" loading="lazy" alt="" className="image-30" />
                </a>
              </div>
              <div className="div-block-37">
                <div className="dvblkhdr2-2">
                  ...
                  <div className="dvblkstd11">
                    <img src="/images/fone-azul.svg" alt="Icone Telefone svg" className="image-26" />
                  </div>
                  <div className="dvblkstd12">
                    <a href="tel:+551132301422" id="sp-fone-link" className="fone-link top sp">(11) 3230-1422</a>
                  </div>
                </div>
                <div className="dvblkhdr2-2">
                  <div className="dvblkstd1">
                  ...
                  <div className="dvblkstd12">
                    <a href="tel:+552140421811" id="rj-fone-link-header" className="fone-link top sp">(21) 4042-1811</a>
                  </div>
                </div>
                <div className="dvblkhdr2-2">
                  <div className="dvblkstd1">
                  ...
                  <div className="dvblkstd11">
                    <img src="/images/whatsapp-azul-2.svg" alt="Icone whatsapp svg" className="image-26" />
                  </div>
                  <div className="dvblkstd12">
                    <a href="#" id="whatsappfone1" data-w-id="5190bf4f-b871-0c25-7006-c637bfea829d" className="whatsapplink">(11) 3230-1422</a>
                  </div>
                </div>
                <div className="dvblkhdr2-2">
                  <div className="dvblkstd1">
                  ...
                  <div className="dvblkstd12">
                    <a href="tel:+5511953288466" id="sp-cellfone-link" className="fone-link-copy top sp">(11) 95328-8466</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="hero hero-auto auto">
          <div className="container_padrao menina w-container">
            <div id="submit_button" whenclicked="set" className="wrapper w-form">
              ...
              >
                <input className="field nome w-input" maxLength="256" name="NOME" placeholder="Nome" type="text" id="NOME" required />
                <div className="div-block-3"></div>
                <div className="text-block-44">
                  Preencher os DDDs e Telefones só com números, sem traços
                </div>
                <input className="field ddd-fone w-input" maxLength="256" name="DDD-CELULAR" placeholder="DDD" type="number" id="DDD-CELULAR" required />
                <input className="field celular noauto w-input" maxLength="256" name="CELULAR" placeholder="CELULAR" type="number" id="CELULAR" required />
                <input className="field ddd-fone w-input" maxLength="256" name="DDD-TELEFONE" placeholder="DDD" type="number" id="DDD-TELEFONE" />
                <input className="field telefone w-input" maxLength="256" name="TELEFONE" placeholder="TELEFONE" type="number" id="TELEFONE" />
                <input className="field email w-input" maxLength="256" name="email" placeholder="Email" type="email" id="email" required />
                <input className="field cep w-input" maxLength="256" name="CEP" placeholder="Cep" type="text" id="CEP" />
                <input className="field cidade noauto w-input" maxLength="256" name="CIDADE" placeholder="Cidade" type="text" id="CIDADE" />
                <input className="field estado w-input" maxLength="256" name="ESTADO" placeholder="UF" type="text" id="ESTADO" />
                <input className="field veiculo w-input" maxLength="256" name="MARCA" placeholder="Marca Ex: FIAT" type="text" id="MARCA" />
                <input className="field veiculo w-input" maxLength="256" name="VEICULO" placeholder="Veiculo ex: Uno" type="text" id="VEICULO" />
                <input className="field seguradora noauto w-input" maxLength="256" name="MODELO" placeholder="Modelo Ex: VIVACE 1.4 Flex" type="text" id="MODELO" />
                <input className="field ano w-input" maxLength="256" name="ANO" placeholder="Ano" type="text" id="ANO" />
                <input type="submit" data-wait="Aguarde..." id="submit_button_form" whenclicked="set" className="submit-button w-button" value="CALCULE AGORA!" />
              </form>
        ...
        <div className="fraude">
          <div className="w-container">
            ...
            <p className="sub-titulo-principal">
              Solicitamos aos amigos e clientes que fiquem atentos à <strong>fraudadores </strong>
              que estão <strong>utilizando o nome da IMEDIATO SEGUROS</strong> para vender serviços de instalação de rastreadores <strong>solicitando transferências via PIX</strong>.<br /><br />
              A IMEDIATO SEGUROS <strong>não efetua qualquer cobrança direta de seus clientes</strong>.<br /><br />
              Atuamos como corretores de seguros, intermediando a venda de produtos de companhias seguradoras devidamente
              registradas nos órgãos reguladores. Essas companhias fazem a cobrança dos seus serviços diretamente aos nossos clientes.
            </p>
          </div>
        </div>
        ...
        <div className="google-reviews">
          <div className="container-13 w-container">
            ...
            <div className="sub-titulo-principal-esp">
              96% DE SATISFAÇÃO (NOTA 4.8 DE 5.0)<br />MAIS DE 1.700 AVALIAÇÕES ESPONTÂNEAS E CERTIFICADAS
            </div>
            ...
            <div className="w-layout-grid grid-7">
              <div className="dvblkseguro">
                <a href="/seguro-auto.html" className="link-blk-seg w-inline-block">
                  <div className="dvblksegurologo">
                    <img src="/images/logo-auto-sem-linha.svg" loading="lazy" alt="" className="imglogoseguro lazyload" />
                  </div>
              ...
              <div className="dvblkseguro caminhao">
                <a href="/seguro-caminhao.html" className="link-blk-seg w-inline-block">
                  <div className="dvblksegurologo">
                    <img src="/images/caminhao-0.svg" alt="" loading="lazy" className="imglogoseguro lazyload" />
                  </div>
                  <div className="dvblksegurodescpreco">
                    <div className="dvblkseguropreo">
              ...
              <div className="dvblkseguro uber">
                <a href="/seguro-uber.html" className="link-blk-seg w-inline-block">
                  <div className="dvblksegurologo">
                    <img src="/images/logo-uber-sem-linha.svg" alt="" loading="lazy" className="imglogoseguro lazyload" />
                  </div>
                  <div className="dvblksegurodescpreco">
                    <div className="dvblkseguropreo">
              ...
              <div className="dvblkseguro utilitarios">
                <a href="/seguro-utilitario.html" className="link-blk-seg w-inline-block">
                  <div className="dvblksegurologo">
                    <img src="/images/logo-utilitario-sem-linha.svg" alt="" loading="lazy" className="imglogoseguro lazyload" />
                  </div>
                  <div className="dvblksegurodescpreco">
                    <div className="dvblkseguropreo">
              ...
              <div className="dvblkseguro motos">
                <a href="/seguro-motos.html" className="link-blk-seg w-inline-block">
                  <div className="dvblksegurologo">
                    <img src="/images/logo-moto-sem-linha.svg" alt="" loading="lazy" className="imglogoseguro lazyload" />
                  </div>
                  <div className="dvblksegurodescpreco">
                    <div className="dvblkseguropreo">
              ...
              <div className="dvblkseguro _24hs">
                <a href="/assistencia-24-horas.html" className="link-blk-seg w-inline-block">
                  <div className="dvblksegurologo">
                    <img src="/images/colisao-branco-centralizado.svg" alt="Colisao svg" loading="lazy" className="imglogoseguro lazyload" />
                  </div>
                  <div className="dvblksegurodescpreco">
                    <div className="dvblkseguropreo">
              ...
              <div className="dvblkseguro taxi">
                <a href="/seguro-taxi.html" className="link-blk-seg w-inline-block">
                  <div className="dvblksegurologo">
                    <img src="/images/logo-taxi-sem-linha.svg" alt="" loading="lazy" className="imglogoseguro lazyload" />
                  </div>
                  <div className="dvblksegurodescpreco">
                    <div className="dvblkseguropreo">
              ...
              <div className="dvblkseguro pet">
                <a href="/assistencia-24-horas.html" className="link-blk-seg w-inline-block">
                  <div className="dvblksegurologo">
                    <img src="/images/pet-pequeno.svg" alt="" loading="lazy" className="imglogoseguro lazyload" />
                  </div>
                  <div className="dvblksegurodescpreco">
                    <div className="dvblkseguropreo">
              ...
              <div className="dvblkseguro fianca">
                <a href="/fianca.html" className="link-blk-seg w-inline-block">
                  <div className="dvblksegurologo">
                    <img src="/images/rental.svg" alt="" loading="lazy" className="imglogoseguro lazyload" />
                  </div>
                  <div className="dvblksegurodescpreco">
                    <div className="dvblkseguropreo">
          ...
          <div className="w-container">
            ...
            <div className="w-layout-grid grid-8">
              <div className="dv-blk-pq">
                <img src="/images/call-center-menina.jpg" alt="" loading="lazy" className="image-16" />
              ...
              <div className="dv-blk-pq">
                <img src="/images/equipe-experiente-mobile-optimized.jpg" alt="" loading="lazy" className="image-16" />
              ...
              <div className="dv-blk-pq">
                <img src="/images/visao-geral-equipe-optimized.jpg" alt="" loading="lazy" className="image-16" />
              ...
              <div className="dv-blk-pq">
                <img src="/images/reputacao-compressed.jpg" alt="" loading="lazy" className="image-16" />
          ...
          <div className="w-container">
            ...
            <div className="div-block-16">
              <div className="dv-blk-condicoes">
                <img src="/images/BEST-PRICE-4.svg" width="169" alt="" loading="lazy" className="img-cond lazyload" />
              ...
              <div className="dv-blk-condicoes">
                <img src="/images/BONUS4.svg" width="169" alt="" loading="lazy" className="img-cond lazyload" />
              ...
              <div className="dv-blk-condicoes">
                <img src="/images/SOB-MEDIDA-2.svg" width="169" alt="" loading="lazy" className="img-cond lazyload" />
              ...
              <div className="dv-blk-condicoes">
                <img src="/images/sinistro.svg" width="169" alt="" loading="lazy" className="img-cond lazyload" />
              ...
              <div className="dv-blk-condicoes">
                <img src="/images/canais-19.svg" width="169" alt="" loading="lazy" className="img-cond lazyload" />
        ...
        <div className="equipe">
          <div className="container-16 w-container">
            ...
            <h4 className="sub-titulo-principal"><strong>39 COLABORADORES </strong>PARA MELHOR ATENDÊ-LO</h4>
              ...
              <div role="list" className="collection-list-3 w-dyn-items">
                <div role="listitem" className="equipe-item w-dyn-item">
                  <div className="div-block-36">
                    <img loading="lazy" alt="" src="" className="image-25 w-dyn-bind-empty" />
                  </div>
                  <div className="text-block-47 w-dyn-bind-empty"></div>
                </div>
              </div>
            ...
            <a href="/equipe.html" className="equipe-botao w-button">CONHEÇA TODOS OS NOSSOS COLABORADORES</a>
          </div>
        </div>
            ...
            <div className="row footer w-row">
              <div className="col rodape w-col w-col-5 w-col-medium-6 w-col-small-6">
                ...
                <div className="div-block-43">
                  ...
                  <div>
                    <a href="https://www2.susep.gov.br/safe/menumercado/certidoes/emite_certidoescorretores_2011.asp?id=9bd84712-1ee6-4171-af95-df8e09bcb1bc" target="_blank" className="link">
                      (Consulte Aqui)
                    </a>
                    <link rel="prefetch" href="https://www2.susep.gov.br/safe/menumercado/certidoes/emite_certidoescorretores_2011.asp?id=9bd84712-1ee6-4171-af95-df8e09bcb1bc" />
                  </div>
                </div>
              ...
              <div className="col rodape w-col w-col-7 w-col-medium-6 w-col-small-6">
                <div className="div-block-39">
                  <div className="dvblkfone">
                    ...
                    <a href="tel:+551132301422" id="sp-fone-link-footer" className="fone-link sp">(11) 3230-1422</a>
                  </div>
                  <div className="dvblkfone">
                    <div className="text-block-12 rod">Rio de Janeiro:</div>
                    <a href="tel:+552140421811" id="rj-fone-link" className="fone-link rj">(11) 4042-1811</a>
                  </div>
                  <div className="dvblkfone whatsapp">
                    <div className="text-block-12 rod">Whatsapp:</div>
                    <a href="#" id="whatsappfone2" data-w-id="c7278769-5329-adee-697d-55273b1b8458" className="whatsapp-link wp">(11) 4171-8837</a>
                  </div>
                  <div className="dvblkfone">
                    <div className="text-block-12 rod">Ouvidoria:</div>
                    <a href="tel:+5511976687668" id="ouvidoria-fone" data-w-id="e83b1be2-9432-3909-2c3d-3bde6d8ea933" className="ouvidoria-link rj">(11) 97668-7668</a>
                  </div>
                  <div className="dvblkfone">
                    <a href="mailto:CONTATO@IMEDIATOSEGUROS.COM.BR" data-w-id="b4118b3e-1879-6b61-ecff-5829284e1a45" className="link-header mail">
        ...
        <Script src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=59eb807f9d16950001e202af" strategy="afterInteractive" />
        ...
        <Script id="click-events" strategy="afterInteractive">
          {`
            $(document).ready(function(){
              ...
              $('#whatsappfone1').on('click', function(e) {
                var gclid = (function(name){ 
                  var n = name + "="; 
                  var cookie = document.cookie.split(';');
                  for(var i=0;i < cookie.length;i++){
              ...
              $('#whatsappfone2').on('click', function(e) {
                var gclid = (function(name){ 
                  var n = name + "="; 
                  var cookie = document.cookie.split(';');
                  for(var i=0;i < cookie.length;i++){
              ...
              $('#CELULAR').on('change', function(e) {
                var ddd = document.getElementById('DDD-CELULAR').value;
                ...
                fetch('https://apilayer.net/api/validate?access_key=dce92fa84152098a3b5b7b8db24debbc&country_code=BR&number=' + number)
                  ...
                  .then(data => {
                    if (!data["valid"]) {
                      ...
                      .then((r) => {
                        if (r) {
                          document.getElementById('DDD-CELULAR').focus();
                        } else {
                          document.getElementById('DDD-TELEFONE').focus();
                        }
                      });
                    }
                  });
              ...
              document.addEventListener('DOMContentLoaded', function() {
                const form = document.getElementById('form-wp');
                if (form) {
                  form.addEventListener('submit', function(e) {
                    e.preventDefault();
                    const whatsappUrl = "https://api.whatsapp.com/send?phone=551141718837&text=Ola.%20Quero%20fazer%20uma%20cotacao%20de%20seguro.%20Codigo%20de%20Desconto%20(Nao%20apagar,%20por%20favor)%20=%20";
        ...
        <noscript>
          <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PD6J398" height="0" width="0" style={{ display: 'none', visibility: 'hidden' }} />
        </noscript>
      </body>
    </>
  );
